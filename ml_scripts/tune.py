...
from ml_scripts import data, train, utils
...
@app.command()
def tune_models(
    experiment_name: Annotated[str, typer.Option(help="name of the experiment for tuning this workload.")] = None,
    ...
    # logging the tuning run results as info log
